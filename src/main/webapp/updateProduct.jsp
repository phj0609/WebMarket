...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-5">
				<img src="${pageContext.request.contextPath}/upload/<%=rs.getString("p_fileName")%>" alt="image" style="width:100%"/>
			</div>
			<div class="col-md-7">
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<textarea name="description" cols="70" rows="2" class="form-control"><%= rs.getString("p_description")%></textarea>
					</div>
				</div>
				<div class="form-group row">
